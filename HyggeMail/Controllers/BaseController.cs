    ...
    public class BaseController : Controller
    {
        ...
        protected override void OnAuthorization(AuthorizationContext filter_context)
        {
            ...
            if (auth_cookie != null)
            {
                ...
                if ((filter_context.ActionDescriptor.ActionName == "Dashboard" && filter_context.ActionDescriptor.ControllerDescriptor.ControllerName == "Home"))
                {
        ...
        /// <summary>
        /// used to create user authorization cookie after login for mobile
        /// </summary>
        /// <param name="user_name"></param>
        /// <param name="is_persistent"></param>
        /// <param name="custom_data"></param>
        protected virtual void CreateCustomAuthorisationCookieForMobile(String user_name, Boolean is_persistent, String custom_data)
        {
            FormsAuthenticationTicket auth_ticket =
                new FormsAuthenticationTicket(
                    1, user_name,
            ...
            String encrypted_ticket_ud = FormsAuthentication.Encrypt(auth_ticket);
            HttpCookie auth_cookie_ud = new HttpCookie(Cookies.AuthorizationCookieMobile, encrypted_ticket_ud);
            if (is_persistent) auth_cookie_ud.Expires = auth_ticket.Expiration;
            System.Web.HttpContext.Current.Response.Cookies.Add(auth_cookie_ud);
        }
        ...
        public void SetActionName(string actionName, string controllerName)
        {
        ...
        protected override void OnActionExecuted(ActionExecutedContext filterContext)
        {
            ...
            //    var currentLoggedInUser = _um.GetUserDetailsByUserId(LOGGEDIN_USER.UserID);
            //    if (currentLoggedInUser.Object.Email == null || currentLoggedInUser.Object.Email == "" && (filterContext.ActionDescriptor.ActionName != "MyProfile" && filterContext.ActionDescriptor.ControllerDescriptor.ControllerName != "Home"))
            //    {
            //        filterContext.Result = RedirectToAction("MyProfile", "Home", new { area = "User" });
            //    }
            //}
        ...
        {
            JsonResult result = Json(new ActionOutput { Status = ActionStatus.Successfull, Message = "", Results = resultString }, JsonRequestBehavior.AllowGet);
