    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/beforeLoginCss").Include(
                      ...
                      "~/Content/js/jquery.mCustomScrollbar.css",
                        "~/Content/sweetalert.css"
                      ));


            bundles.Add(new StyleBundle("~/Content/newbeforeLoginCss").Include(
                    "~/Content/bootstrap.min.css",
                    "~/Content/fonts/font-awesome-4/css/font-awesome.min.css",
                    "~/Content/themes/jquery.gritter/css/jquery.gritter.css",
                    "~/Content/owl.carousel.min.css",
            ...
            bundles.Add(new StyleBundle("~/Content/UserDashbordCSS").Include(
          "~/Content/UserCSS.css",
                     "~/Content/themes/jquery.gritter/css/jquery.gritter.css",
                          "~/Content/bootstrap.min.css",
                      "~/Content/fonts/font-awesome-4/css/font-awesome.min.css",
                ...
                //"~/Content/jquery.fullPage.css",
                      "~/Content/themes/bootstrap.datetimepicker/css/bootstrap-datetimepicker.min.css",
                       "~/Content/responsive.css",
                      "~/Content/sweetalert.css",
                      "~/Content/themes/slick/slick-theme.css",
                      "~/Content/themes/slick/slick.css",
                      "~/Content/js/jquery.mCustomScrollbar.css",
            ...
            bundles.Add(new StyleBundle("~/Content/adminLayoutCSS").Include(
                   ...
                   "~/Content/adminStyle.css",
                       "~/Content/font-family.css"));
            bundles.Add(new ScriptBundle("~/bundles/beforeLoginJquery").Include(
              "~/Scripts/jquery.fancybox.js",
              "~/Scripts/UserDefinedScripts/active.js",
              "~/Scripts/owl.carousel.min.js",
              "~/Scripts//FrontEndScripts/InitilizeJS.js",
                 "~/Content/themes/jquery.gritter/js/jquery.gritter.js",
                "~/Scripts/smk-accordion.js",
                "~/Content/js/jquery.mCustomScrollbar.concat.min.js"

              ));

            bundles.Add(new ScriptBundle("~/bundles/UserDashboard").Include(
              "~/Scripts/owl.carousel.min.js",
                "~/Scripts/smk-accordion.js",
                "~/Content/themes/slick/slick.js",
                "~/Scripts/UserDefinedScripts/active.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/extendedjs").Include(
                ...
                //"~/Content/themes/jquery.select2/select2.min.js",
                 ...
                 "~/Content/themes/jscolor-2.0.4/jscolor.min.js"
                ));
