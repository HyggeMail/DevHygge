$(document).ready(function () {
    ...
    $("a.SendAccountVerificationMail").live("click", function () {
        return Users.SendAccountVerificationMail($(this));
    });
});
...
var Users = {
    ...
    ActivateUser: function (sender) {
        ...
        //});
        $.ajaxExt({
            url: baseUrl + '/Admin/User/ActivateUser',
            type: 'POST',
            validate: false,
            showErrorMessage: true,
            messageControl: $('div.messageAlert'),
    ...
    SendAccountVerificationMail: function (sender) {
        //$.ConfirmBox("", "Are you sure?", null, true, "Yes", true, null, function () {

        //});
        $.ajaxExt({
            url: baseUrl + '/Admin/User/SendAccountVerificationMail',
            type: 'POST',
            validate: false,
            showErrorMessage: true,
            messageControl: $('div.messageAlert'),
